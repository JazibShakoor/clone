...
const Hero = ({ address, phone, email }) => {
    ...
    />
      <div className="w-full h-auto lg:h-screen relative">
        <div className="relative h-screen text-center flex flex-col justify-center items-center">
          ...
          <h1 className="font-normal text-4xl lg:text-7xl text-center mt-4 text-white shadow-2xl capitalize opacity-80 rounded-2xl cursor-pointer  ">
  ...
  <div className="flex mr-11">
    <Image
      src={arrowIcon}
      alt="arrow icon"
      className="w-5 h-5 mx-2 sm:mx-9 self-center"
    />
