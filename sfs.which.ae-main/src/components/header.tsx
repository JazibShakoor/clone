...
const Header = () => {
  ...
  return (
    <div
      ...
      className=" fixed top-0 left-0 w-full h-20 shadow-2xl flex justify-between items-center z-40  ease-out duration-200"
    >
      {/* Menu + Name */}
      ...
      <div className="max-w-[1240px] m-5 flex justify-between items-center p-4 ">
        <Link href="/">
          <h1
            ...
            className="py-2 text-2xl font-semibold  hover:text-blue-500  "
          >
          Dmaxx Properties
          </h1>
        </Link>
